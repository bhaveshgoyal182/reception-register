...
mongoose.connect('mongodb+srv://bhaveshgoyal182:Goyal%406425@cluster0.rht77.mongodb.net/myFirstDatabase?retryWrites=true&w=majority')
.then(()=>{
...
function sendemail(email,cinh,cinm){
   ...
   const  sendgrid='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';
  ...
  const msg={
      to: email,
      from: "bhavesh0594.cse19@chitkara.edu.in",
